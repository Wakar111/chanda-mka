...
export default function ResetPassword() {
  ...
  return (
    <div className="flex items-center justify-center px-4 py-4 md:py-8 h-full">
      <div className="max-w-md mx-auto w-full">
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6">
          <div className="text-center mb-8">
            <h1 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 md:mb-6">Passwort festlegen</h1>
