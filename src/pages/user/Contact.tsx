                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1">WhatsApp</label>
                          <a 
                      ...
                      {collector.nizam && (
                        <div className="flex items-start">
                          ...
                          <div>
                            <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1">Nizam</label>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <label className="block text-xs md:text-sm font-medium text-gray-700 mb-1">Zeitraum</label>
